...
import com.luteapp.sleeptimer.SleepNotification.Action.CANCEL
import com.luteapp.sleeptimer.SleepNotification.Action.DECREMENT
import com.luteapp.sleeptimer.SleepNotification.Action.INCREMENT
...
object SleepNotification {
    ...
    private enum class Action(private val value: String) {
        CANCEL("com.luteapp.sleeptimer.action.CANCEL") {
            override fun title(context: Context) = context.getText(R.string.notification_action_cancel)
        },
        INCREMENT("com.luteapp.sleeptimer.action.INCREMENT") {
        ...
        DECREMENT("com.luteapp.sleeptimer.action.DECREMENT") {
            override fun title(context: Context) = context.getString(
